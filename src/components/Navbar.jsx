...
const Navbar = () => (
  <Grid container columns={{ xs: 7, md: 12 }} spacing={3} sx={{padding:'16px 0 16px 16px'}} alignItems='center'>
      <Grid item md={2} xs={2}>
        <Link
          to="/"
      ...
      <Grid item md={2} xs={0} sx={{paddingLeft:'0 !important'}}/>
      <Grid item md={5} xs={3}>
        <SearchBar />
      </Grid>
      <Grid item md={2} xs={0} sx={{paddingLeft:'0 !important'}}/>
      <Grid item md={1} xs={2} sx={{paddingLeft:'0 !important'}}>
        <Box sx={{alignItems:'center'}}>
          <Link to='/login' >
            <Box sx={{display:'flex',alignItems:'center', border:'1px solid #2a2a2a',borderRadius:'20px',width:'105px',height:'35px','&:hover':{cursor:'pointer',opacity:'0.8'}}}>
              <AccountCircleOutlinedIcon sx={{color:'#368bd5',width:'40px'}} />
